...
- ad_tone_mentionbased/ad_tone_mentionbased_FB_140m.R requires the [`race_of_focus_140m.rdata'](https://github.com/Wesleyan-Media-Project/race_of_focus/blob/main/data/race_of_focus_140m.rdata) file of the race of focus repo, the `fb_2020_140m_adid_var1.csv.gz` file that will be on Figshare (ADD FIGSHARE LINK HERE) and [entity linking](https://github.com/Wesleyan-Media-Project/entity_linking)
